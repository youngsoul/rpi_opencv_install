# script or instructions to install opencv 4.5.5
# on raspberry pi with BullsEye OS
# THIS WILL NOT WORK WITH LATEST RASPBERRY PI OS because they removed PiCamera
# support UNLESS you enable 'legacy camera support'.
# Tested on Jan 9, 2022
